...
*| --libs.scss - файл для импорта стилей библиотек скачанных через bower (пример: @import "app/libs/magnific-popup/dist/magnific-popup.css" // Импортируем библиотеку Magnific Popup)
